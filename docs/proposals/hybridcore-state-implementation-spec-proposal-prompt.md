...
- Provide exhaustive testing/linting requirements: schema fixtures, concurrency simulations, corruption injection tests, and CLI commands that surface state inconsistencies.
  - Reference diagrams: [state map](openspec/specs/hybridcore-state/state-map.md), [write/migration flow](openspec/specs/hybridcore-state/state-io.md), [schema upgrade workflow](openspec/specs/hybridcore-state/migration-workflow.md).
...
Change-Start: add-hybridcore-state-implementation-spec 2025-11-08T22:25:00Z
Change-Archived: add-hybridcore-state-implementation-spec 2025-11-08T22:44:00Z
-->
